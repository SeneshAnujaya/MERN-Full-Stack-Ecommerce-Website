...
const Login = ({setToken}) => {
  ...
  return (
    ...
    <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        <h1 className='text-2xl font-medium mb-4'>Modveil Admin Panel</h1>
        <form onSubmit={onSubmitHandler}>
          ...
          <button className='mt-8 w-full py-2 px-4 rounded-md text-white bg-black' type='submit'>Login</button>
        </form>
      </div>
      </div>
